...
import {
  ...
  canonicalPrompt,
} from './orderAgentHelpers';
// Re-export the one helper that external callers have always pulled
// from this module so we don't break import paths.
export { parsePickupPhrase };
...
// canonicalPrompt and buildOwnerOrderSummary moved to
// orderAgentHelpers.ts (imported at top of this file).
