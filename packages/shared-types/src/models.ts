...
export const BusinessLimitsSchema = z.object({
  ...
  locationChangesRequireStaff: z.boolean().default(false),
  quotesRequireStaff: z.boolean().default(false),
  scheduleChangesRequireStaff: z.boolean().default(false),
  noArrivalTimeGuarantees: z.boolean().default(false),
  noOutcomeGuarantees: z.boolean().default(false),
  urgentRequestsRequireStaff: z.boolean().default(false),
  noProfessionalAdvice: z.boolean().default(false),
  confidentialInfoRequiresStaff: z.boolean().default(false),
  noMedicalAdvice: z.boolean().default(false),
  emergenciesRequire911: z.boolean().default(false),
  noAvailabilityPromises: z.boolean().default(false),
  coverageAndCostsRequireStaff: z.boolean().default(false),
  sensitiveHealthInfoRequiresStaff: z.boolean().default(false),
  inventoryRequiresStaffConfirmation: z.boolean().default(false),
  holdsRequireStaffConfirmation: z.boolean().default(false),
...
export const TenantConfigSchema = z.object({
  ...
  voiceGreetingReturning: z.string().nullable().optional(),
  ...
  industryTemplateKey: z.string().nullable().optional(),
  consentMessage: z.string().nullable().optional(),
  followupOpener: z.string().nullable().optional(),
