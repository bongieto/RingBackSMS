...
async function main() {
    ...
    const tenant = await prisma.tenant.upsert({
        ...
        create: {
            ...
            businessType: client_1.BusinessType.RESTAURANT,
    ...
    await prisma.tenantConfig.upsert({
        ...
        create: {
            tenantId: tenant.id,
            greeting: "Hi! Sorry we missed your call at The Lumpia House. Reply ORDER to place a food order, MEETING to schedule a call with our owner, or just tell us what you need!",
    ...
    // Create Flows
    const flows = [
        { type: client_1.FlowType.ORDER, isEnabled: true },
        { type: client_1.FlowType.MEETING, isEnabled: true },
        { type: client_1.FlowType.FALLBACK, isEnabled: true },
    ];
