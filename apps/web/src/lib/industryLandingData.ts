...
const SERVICE_BUSINESSES: IndustryLandingContent = {
  ...
  faqs: [
    ...
    { q: 'How much does it cost?', a: 'Free plan up to 50 SMS/month. Pro at $49/mo covers up to 1,000 SMS which is enough for most solo operators. Business at $129/mo for busy multi-staff shops.' },
  ],
  statBar: COMMON_STATS,
