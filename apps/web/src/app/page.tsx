...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'RingBackSMS offers a free plan with up to 50 SMS per month. Paid plans start at $49/month for Pro (1,000 SMS), $129/month for Business (5,000 SMS + POS integration), and $299/month for Scale (20,000 SMS + unlimited AI calls + API access).',
      },
    },
    {
      '@type': 'Question',
...
const PRICING = [
  ...
  },
  {
    ...
    features: [
      'Everything in Free',
      '3 team members',
      'All flows (Order, Meeting, Inquiry, Custom)',
  ...
  },
  {
    ...
    features: [
      'Everything in Pro',
      '3 phone numbers, 10 team members',
      'POS integration (Square, Clover, Toast, Shopify)',
      'All flows + custom flows',
      'Full analytics & recovery funnel',
      'Slack notifications',
      'Priority support',
    ],
    cta: 'Start 14-Day Trial',
