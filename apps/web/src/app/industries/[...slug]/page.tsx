...
const PRICING_PLANS = [
  {
    ...
    sms: '50 SMS/month',
    features: ['1 phone number', '1 team member', 'Fallback flow only', 'Voicemail transcription & tags', 'Reply templates', 'Email notifications'],
    cta: 'Start Free',
    highlighted: false,
  },
  {
    ...
    sms: '1,000 SMS/month',
    features: ['Everything in Free', '3 team members', 'All flow types (Order, Meeting, Inquiry, Custom)', 'Caller memory & reorder shortcuts', 'Basic analytics', 'Custom AI personality'],
  ...
  },
  {
    ...
    description: 'Busy multi-staff shops',
    sms: '5,000 SMS/month',
    features: ['Everything in Pro', '3 phone numbers, 10 team members', 'POS integration (Square, Clover, Toast, Shopify)', 'All flows + custom flows', 'Full analytics & recovery funnel', 'Slack notifications', 'Priority support'],
    cta: 'Start 14-day trial',
    highlighted: false,
  },
  {
    ...
    description: 'Agencies & multi-location',
    sms: '20,000 SMS/month',
    features: ['Everything in Business', 'Unlimited phones & team', 'Unlimited AI calls', 'API access', 'Multi-location support', 'Priority phone support'],
    cta: 'Start 14-day trial',
    highlighted: false,
  },
];
